...
let apiLink = "https://v6.exchangerate-api.com/v6/c16f401ce70c9ebe6dd98b5b/latest/PKR";
...
let userMoney = await inquirer.prompt({
    type: "number",
    name: "rupees",
    message: `please enter the amount in ${chalk.greenBright.bold(firstCountry.c1name)}:`
});
// converted country.
...
// conversion rate.
let cnv = `https://v6.exchangerate-api.com/v6/c16f401ce70c9ebe6dd98b5b/pair/${firstCountry.c1name}/${secondCountry.c2name}`;
